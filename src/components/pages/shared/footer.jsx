...
const Footer = () => {
    return (
        <div className='bg-base-200'>
            <footer className="footer p-10 text-base-content w-10/12 mx-auto">
                <div>
            ...
            <footer className="footer w-10/12 mx-auto px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>©copyright. All right reserved by The Hungry Cat.</p>
                </div>
