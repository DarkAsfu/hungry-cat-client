        ...
        <div className='bg-slate-100 sticky top-0 z-10'>
            <div className="navbar md:w-10/12 mx-auto">
                <div className="navbar-start">
                    ...
                    <img className='md:block hidden w-10' src={logo} alt="" />
                    <a className="btn btn-ghost normal-case text-xl">The Hungry Cat</a>
                </div>
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal">
                        <NavLink style={{paddingRight: "15px", fontSize: "18px"}} to="/" className={({ isActive, isPending }) =>
                            isPending ? "pending" : isActive ? "active" : ""
                        }>Home</NavLink>
                        <NavLink style={{paddingRight: "15px", fontSize: "18px"}} to="/blog" className={({ isActive, isPending }) =>
                            isPending ? "pending" : isActive ? "active" : ""
                        }>Blog</NavLink>
